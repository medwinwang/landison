...
@XmlSeeAlso({
    SvcMemberInfo.class,
    MemberGetPointsByWay.class,
    OrderInfoPaymentGateway.class,
    SimpleSvcMemberInfo.class,
    MemberOnlineCommunication.class,
    MemberInfoLevel.class,
    MemberInfoVipStatus.class,
    MemberInfoFFP.class,
    FfpAttribute.class,
    SvcSubMemberInfo.class,
    SvcMemberHistoryInfo.class,
    SvcMemberPointInfo.class,
    SvcCouponInfo.class,
    SvcPointExchangeInfo.class,
    SvcMemberCardFeeInfo.class,
    SvcMemberNotification.class,
    GuestFolioInfo.class,
    MemberNextLevel.class
})
